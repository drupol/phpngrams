...
{
    public function it_can_calculate_the_frequency(): void
    {
        $input = 'Hold my beer';
    ...
    public function it_can_get_ngram_from_a_string(): void
    {
        $result = [
            str_split('h'),
            str_split('e'),
    ...
    public function it_can_get_ngram_from_a_string_with_big_n(): void
    {
        $result = [
            str_split('hello'),
        ];
    ...
    public function it_can_get_ngram_from_an_array(): void
    {
        $result = [
            ['h', 'e'],
            ['e', 'l'],
    ...
    public function it_can_get_ngram_from_an_array_with_big_n(): void
    {
        $result = [
            ['h', 'e', 'l', 'l', 'o'],
        ];
    ...
    public function it_can_get_ngram_from_an_array_without_cycling(): void
    {
        $result = [
            ['h', 'e', 'l'],
            ['e', 'l', 'l'],
